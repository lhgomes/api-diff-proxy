...
def test_primary_content_type_is_preserved(monkeypatch):
    ...
    async def fake_call(client, base_url, request, body):
        return httpx.Response(200, content=b"plain response", headers={"content-type": "text/plain; charset=utf-8"}), 1.0, None
